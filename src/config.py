...
H_RANSAC_THRESHOLD: float = 1.0
DISTANCE_THRESHOLD: float = 130.0
MAP_CLEAN_MAX_DISTANCE: float = 135.0
...
TRIANGULATION_THRESHOLD_DEG: float = 0.5
TRIANGULATION_THRESHOLD: float = np.deg2rad(TRIANGULATION_THRESHOLD_DEG)
BUNDLE_ADJUSTMENT_FRAMES: int = 3
FORCE_KEYFRAME_INTERVAL: int = 5
HOMOGRAPHY_INLIER_RATIO: float = 0.1
